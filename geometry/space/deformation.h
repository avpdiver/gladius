...
#ifndef GLADIUS_DEFORMATION_H
#define GLADIUS_DEFORMATION_H

#include "../../core/math/vec3.h"
#include "../../core/math/mat4.h"
#include "../../core/math/box2.h"
 ...
 * reference frame. A c_deformation is also responsible to set the shader uniforms
 ...
 */
            ...
            public:
                 ...
                 * TerrainQuad of the given c_quad_tree. This method can set the uniforms
                 * that are common to all the quads of the given terrain.
                 *
                 * @param context the SceneNode to which the c_quad_tree belongs. This node
                 *      defines the absolute position and orientation of the terrain in
                 *      world space (through SceneNode#getLocalToWorld).
                 * @param n a c_quad_tree.
                 */
                //virtual void setUniforms(ptr <SceneNode> context, c_quad_tree* n, ptr <Program> prog) const;
                 ...
                 */
                //virtual void setUniforms(ptr <SceneNode> context, c_tree_node* q, ptr <Program> prog) const;
                 ...
                 *
                 * @param t a c_quad_tree. This is node is used to get the camera position
                 *      in local and deformed space with c_quad_tree#get_local_camera and
                 *      c_quad_tree#get_deformed_camera, as well as the view frustum planes
                 *      in deformed space with c_quad_tree#get_deformed_frustum_planes.
                 * @param localBox a bounding box in local space.
            ...
            protected:
                 ...
                 * call to setUniforms(ptr<SceneNode>, ptr<c_quad_tree>, ...).
                 */
                ...
                //virtual void setScreenUniforms(ptr <SceneNode> context, c_tree_node* q, ptr <Program> prog) const;
            };
        }
    }
}

#endif //GLADIUS_DEFORMATION_H
